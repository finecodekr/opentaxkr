    ...
    def calculate(self):
        ...
        self.TI02_양도소득세과세표준신고서_기본사항 = [
            TI02_양도소득세과세표준신고서_기본사항(전화번호=self.납세자.휴대전화번호,
                                   ...
                                   국적코드=self.납세자.국적코드,
                                   도로명_도로명코드=self.납세자.도로명주소.도로명코드,
                                   도로명_도로명=self.납세자.도로명주소.도로명,
                                   도로명_지하만있는건물구분=self.납세자.도로명주소.지하여부,
                                   도로명_건물번호_본번=self.납세자.도로명주소.건물본번,
                                   도로명_건물번호_부번=self.납세자.도로명주소.건물부번,
                                   도로명_아파트동_도로명='',
                                   도로명_아파트호_도로명='',
                                   도로명_읍면동일련번호=self.납세자.도로명주소.읍면동일련번호,
                                   주소_번지=self.납세자.도로명주소.지번본번_번지,
                                   주소_호=self.납세자.도로명주소.지번부번_호,
                                   주소_아파트명=self.납세자.도로명주소.건물명,
                                   주소_아파트호=self.납세자.도로명주소.상세주소,
                                   주소_특수지코드=self.납세자.도로명주소.특수지코드)
        ]
