...
class TI01_양도소득세과세표준신고서_HEADER(ERSRecord):
    ...
    작성일자: date = field(metadata={'max_length': 8, '점검': '길이점검', '비고': 'Not Null'})
    양도일자: date = field(metadata={'max_length': 8, '점검': '길이점검', '비고': 'Not Null'})
    세무대리인성명: str = field(default=None, metadata={'max_length': 60, '점검': '길이점검', '비고': 'Null 허용'})
    세무대리인생년월일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Null 허용'})
...
class TI05_양도소득금액_계산명세(ERSRecord):
    ...
    거래일자_양도일자: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    ...
    거래일자_취득일자: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
...
class TI06_주식양도소득금액_계산명세(ERSRecord):
    ...
    양도일자: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    ...
    취득일자: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
...
class TI07_취득가액및필요경비계산상세명세(ERSRecord):
    ...
    지급일자: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': '항목설명 참조'})
...
class TI12_매매계약서_거래내역(ERSRecord):
    ...
    일련번호: str = field(default=None, metadata={'max_length': 6, '점검': '숫자,길이점검', '비고': 'Not null default 1'})
    일련번호_상세: str = field(default=None, metadata={'max_length': 6, '점검': '숫자,길이점검', '비고': 'Not null default 1'})
    거래내역_일자: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not null'})
...
class TI14_농어촌주택_등_취득자에_대한_과세특례신고서(ERSRecord):
    ...
    취득일자: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    계약금납부일: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    양도일자: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    농어촌주택등의보유기간_시작일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Null허용'})
    농어촌주택등의보유기간_종료일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Null허용'})
...
class TI15_1세대1주택_특례적용신고서(ERSRecord):
    ...
    취득일자: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    양도일자: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    거주기간_시작일: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    거주기간_종료일: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
...
class TI16_1세대3주택이상자의_장기임대주택_등_일반세율적용신청서(ERSRecord):
    ...
    양도주택_취득일: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    양도주택_양도일: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    양도주택임대내용_사업자등록등이후기준호수임대기간_시작일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Null 허용'})
    양도주택임대내용_사업자등록등이후기준호수임대기간_종료일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Null 허용'})
    양도주택임대내용_공제기간_시작일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Null 허용'})
    양도주택임대내용_공제기간_종료일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Null 허용'})
    양도주택임대내용_주택임대기간: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Null 허용'})
    양도주택임대내용_세법상사업자등록_등록일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Null 허용'})
    양도주택임대내용_세법상사업자등록_등록호수: int = field(default=0, metadata={'max_length': 13, '점검': '', '비고': 'Not Null default 0'})
    양도주택임대내용_임대주택법에의한임대사업자등록_등록일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Null 허용'})
...
class TI17_1세대3주택이상자의_장기임대주택_등_일반세율적용신청서_상세(ERSRecord):
    ...
    소재지_통: str = field(default=None, metadata={'max_length': 4, '점검': '길이점검', '비고': 'Null허용'})
    소재지_반: str = field(default=None, metadata={'max_length': 4, '점검': '길이점검', '비고': 'Null허용'})
    개시일: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    종료일: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    임대기간등: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
...
class TI18_공익사업용토지_등에_대한_세액감면신청서(ERSRecord):
    ...
    매입토지_매입일: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    매입토지_계약일: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
...
class TI19_장기임대주택_또는_신축임대주택_양도소득세액감면_면제_신청서(ERSRecord):
    ...
    일련번호: str = field(default=None, metadata={'max_length': 6, '점검': '숫자,길이점검', '비고': 'Not null default 1'})
    양도물건_양도일자: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    ...
    주택임대기간_개시일: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    주택임대기간_종료일: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    주택임대기간_공제기간_시작일: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    주택임대기간_공제기간_종료일: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
...
class TI21_미분양주택과세특례적용신고서_미분양주택양도명세(ERSRecord):
    ...
    취득_계약일자: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    양도일자: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    공란: str = field(default=None, metadata={'max_length': 56, '점검': '길이점검', '비고': 'SPACE'})
...
class TI22_구조조정대상부동산_등_세액감면신청서(ERSRecord):
    ...
    일련번호: str = field(default=None, metadata={'max_length': 6, '점검': '숫자,길이점검', '비고': 'Not null default 1'})
    과세연도_시작일: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    과세연도_종료일: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    양도소득금액: int = field(default=0, metadata={'max_length': 13, '점검': '정수형식점검', '비고': 'Not Null default 0'})
...
class TI23_양도소득세특례세율적용신청서(ERSRecord):
    ...
    양도주택_취득일자: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    양도주택_양도일자: date = field(metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not Null'})
    ...
    신축주택취득_취득일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Null허용'})
...
class TI24_조합원입주권_소유자_1세대1주택_특례적용신고서(ERSRecord):
    ...
    취득일자: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not null'})
    양도일자: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not null'})
    거주기간_시작일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not null'})
    거주기간_종료일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not null'})
    사업시행인가일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not null'})
    관리처분계획인가일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not null'})
    완성일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not null'})
...
class TI25_현물출자등에_대한_세액감면_면제신청서(ERSRecord):
    ...
    과세연도_시작일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not null'})
    과세연도_종료일: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not null'})
...
class TI27_주식거래명세서_상세(ERSRecord):
    ...
    양도내용_양도일자: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not null'})
    ...
    취득내용_취득일자: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not null'})
...
class TI29_대주주등신고서_상세(ERSRecord):
    ...
    증가_일자: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not null'})
    ...
    감소_일자: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not null'})
    ...
    대주주된날현재_일자: date = field(default=None, metadata={'max_length': 8, '점검': '일자형식점검', '비고': 'Not null'})
