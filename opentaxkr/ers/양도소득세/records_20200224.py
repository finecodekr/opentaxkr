...
class TI01_양도소득세과세표준신고서_HEADER(ERSRecord):
    ...
    세무대리인주민등록번호: str = ERSField(default=None, 길이=13, 누적=157, 점검='주민등록번호CHECK', 비고='Null허용')
    세무대리인성명: str = ERSField(default=None, 길이=30, 누적=187, 점검='길이점검', 비고='Null허용')
    세무대리인전화번호: str = ERSField(default=None, 길이=12, 누적=199, 점검='길이점검', 비고='Null허용')
    세무대리인사업자등록번호: str = ERSField(default=None, 길이=10, 누적=209, 점검='사업자번호CHECK+무세적', 비고='Null허용')
    ...
    공란: str = ERSField(default=None, 길이=65, 누적=300, 점검='길이점검', 비고='SPACE')
...
class TI03_양도소득과세표준신고서_세율별내역(ERSRecord):
    ...
    소득감면대상_소득금액: int = ERSField(default=0, 길이=13, 누적=378, 점검='양의실수형식점검', 비고='Not Null default 0 (6)')
    가산세_기장불성실등: int = ERSField(default=0, 길이=13, 누적=391, 점검='양의실수형식점검', 비고='Not Null default 0 (14)')
    공란: str = ERSField(default=None, 길이=9, 누적=400, 점검='길이점검', 비고='SPACE')
...
class TI05_양도소득금액_계산명세(ERSRecord):
    ...
    공란: str = ERSField(default=None, 길이=48, 누적=700, 점검='길이점검', 비고='SPACE')
...
class TI06_주식양도소득금액_계산명세(ERSRecord):
    ...
    취득유형별양도주식수: int = ERSField(default=0, 길이=13, 누적=76, 점검='양의실수형식점검', 비고='Not Null default 0')
    양도일자: date = ERSField(길이=8, 누적=84, 점검='일자형식점검', 비고='Not Null')
    주당양도가액: int = ERSField(default=0, 길이=13, 누적=97, 점검='양의실수형식점검', 비고='Not Null default 0')
    양도가액: int = ERSField(default=0, 길이=13, 누적=110, 점검='양의실수형식점검', 비고='Not Null default 0')
    취득일자: date = ERSField(길이=8, 누적=118, 점검='일자형식점검', 비고='Not Null')
    주당취득가액: int = ERSField(default=0, 길이=13, 누적=131, 점검='양의실수형식점검', 비고='Not Null default 0')
    취득가액: int = ERSField(default=0, 길이=13, 누적=144, 점검='양의실수형식점검', 비고='Not Null default 0')
    필요경비: int = ERSField(default=0, 길이=13, 누적=157, 점검='양의실수형식점검', 비고='Not Null default 0')
    과세대상양도소득금액: int = ERSField(default=0, 길이=13, 누적=170, 점검='정수형식점검', 비고='Not Null default 0')
    감면소득금액: int = ERSField(default=0, 길이=13, 누적=183, 점검='양의실수형식점검', 비고='Not Null default 0')
    감면종류: str = ERSField(길이=3, 누적=186, 점검='', 비고='Not Null')
    감면율: Decimal = ERSField(default='0', 길이=5, 누적=191, 점검='양의실수형식점검', 비고='Not Null default 0', 소수점길이=2)
    자동계산불러오기구분값: str = ERSField(길이=1, 누적=192, 점검='', 비고='Not Null')
    국내외구분: str = ERSField(길이=1, 누적=193, 점검='', 비고='Not Null')
    소재지국: str = ERSField(길이=3, 누적=196, 점검='', 비고='Not Null')
    소재지국명: str = ERSField(길이=40, 누적=236, 점검='', 비고='Not Null')
    ISIN코드: str = ERSField(default=None, 길이=15, 누적=251, 점검='', 비고='Null허용')
    ISIN코드구분: str = ERSField(default=None, 길이=3, 누적=254, 점검='', 비고='Null허용')
    필요경비신고자료일련번호: int = ERSField(default=None, 길이=6, 누적=260, 점검='양의실수형식점검', 비고='NotNull default 0')
    과세이연_여부: str = ERSField(default=None, 길이=2, 누적=262, 점검='02, ZZ', 비고='NULL 허용')
    전체양도소득금액: str = ERSField(default='0', 길이=13, 누적=275, 점검='양의실수형식점검', 비고='Not Null default 0')
    비과세양도소득금액: str = ERSField(default='0', 길이=13, 누적=288, 점검='양의실수형식점검', 비고='Not Null default 0')
    공란: str = ERSField(default=None, 길이=12, 누적=300, 점검='길이점검', 비고='SPACE')
...
class 양도소득세신고(ERSReport):
    published_date: ClassVar[date] = date(2020, 2, 24)
